    ...
    return (
        <div className="auth-shell flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                >
                    <motion.h2
                        className="text-4xl font-extrabold bg-gradient-to-r from-[#8B5E34] to-[#B08968] bg-clip-text text-transparent"
                    ...
                    <motion.form
                        ...
                        >
                                    ...
                                    {isRegistering && (
                                        ...
                                        >
                                            ...
                                            <motion.input
                                                ...
                                                className="appearance-none relative block w-full px-4 py-3 border border-stone-300 rounded-xl text-stone-900 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-[#8B5E34] focus:border-transparent transition-all duration-200"
                                            />
                                        </motion.div>
                                    )}
                                </AnimatePresence>
                            ...
                            <motion.button
                                ...
                                type="submit"
                                disabled={loading}
                                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white bg-gradient-to-r from-[#8B5E34] to-[#B08968] hover:from-[#6F4726] hover:to-[#8B5E34] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8B5E34] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                            >
                                {loading ? (
                                    <motion.div
                                        animate={{ rotate: 360 }}
                            ...
                            <div className="text-center">
                                <motion.button
                                    ...
                                    type="button"
                                    onClick={toggleMode}
                                    className="text-[#8B5E34] hover:text-[#6F4726] text-sm font-medium transition-colors duration-200 cursor-grab active:cursor-grabbing"
                                >
                                    {isRegistering
